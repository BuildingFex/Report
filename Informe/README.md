...
|:-----------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 5.c.1 Trabaja en equipo para proporcionar liderazgo en forma conjunta                                | Sebastian Martin Beingolea Montalvo — U202217853<br>TB1: Asumí responsabilidades compartidas dentro del equipo, coordinando tareas y apoyando a mis compañeros para mantener una organización eficiente y colaborativa durante el desarrollo del trabajo.<br>TP: Colaboré en la organización de las mejoras del documento y en la coordinación de actividades relacionadas con el Sprint 2, promoviendo una comunicación constante entre los integrantes para mantener un trabajo colaborativo y ordenado. <br>AV2: Colaboré en la coordinación de las mejoras del documento y en la supervisión de avances de la Landing Page, promoviendo la comunicación constante entre los integrantes para asegurar el cumplimiento de las actividades planificadas.<br> **TB2:** Coordiné con el equipo la corrección de errores del frontend y backend, apoyando la integración entre ambos componentes y el despliegue del backend para garantizar el correcto funcionamiento de la aplicación.<br><br>Villanueva Rodríguez Giuseppe Adrián — U20221c554<br>TB1: Contribuí al liderazgo conjunto promoviendo la comunicación constante entre los integrantes y motivando la participación activa de todos en la toma de decisiones del proyecto.<br>TP: Participé activamente en la revisión y mejora del documento del proyecto, apoyando en la integración de aportes del equipo y fomentando un ambiente de trabajo participativo e inclusivo durante el desarrollo del Sprint 2.<br>AV2: Participé en la revisión y actualización del documento del proyecto, apoyando la integración de aportes relacionados con la Landing Page y la implementación del backend, favoreciendo el trabajo colaborativo del equipo.<br>**TB2:** Colaboré en la revisión y validación de las funcionalidades implementadas, participando en la corrección de errores y apoyando la integración entre el frontend y el backend para asegurar una aplicación estable.<br><br>Saul Ortega Muñoz — U20231c019<br>TB1: Participé activamente en la distribución equilibrada de tareas, colaborando con el equipo para garantizar que todos pudiéramos aportar y avanzar de manera coordinada. <br>TP: Colaboré en el desarrollo del frontend de la aplicación apoyando en la implementación de interfaces y en la integración de componentes visuales, manteniendo una comunicación constante con el equipo para fomentar un trabajo colaborativo e inclusivo.<br>AV2: Colaboré en el desarrollo de la Landing Page y en la implementación de una parte del backend, coordinando con mis compañeros la integración de funcionalidades y manteniendo una comunicación efectiva para facilitar el trabajo conjunto.<br>**TB2:** Participé en la corrección de errores del frontend y backend, colaborando en la integración de los servicios y en las pruebas funcionales para verificar el correcto funcionamiento de la aplicación.<br><br>Alejandro Manuel Jave Chang — U202312510<br>TB1: Apoyé en la coordinación de ideas y actividades grupales, fomentando un liderazgo colaborativo basado en el respeto, la cooperación y el cumplimiento de objetivos comunes.<br>TP: Apoyé en la elaboración del capítulo 5 y en la coordinación de tareas relacionadas con el Sprint 2, contribuyendo a que el equipo trabajara de manera organizada y alineada con los objetivos del proyecto.<br>AV2: Apoyé en la organización de las actividades relacionadas con las mejoras del documento y el desarrollo del proyecto, contribuyendo a que el equipo trabajara de forma coordinada y alineada con los objetivos establecidos.<br>**TB2:** Apoyé en la organización de las actividades finales del proyecto, participando en la validación de las funcionalidades implementadas y en el seguimiento del despliegue del backend para cumplir los objetivos establecidos.<br><br>Valentin Nicolas Medina Mamani — U202316829<br>TB1: Colaboré en la planificación de las actividades del equipo, impulsando un ambiente de trabajo participativo donde cada integrante pudiera asumir responsabilidades y contribuir al logro del proyecto. <br>TP: Colaboré en las mejoras del documento y en la revisión del contenido desarrollado para el Sprint 2, promoviendo el apoyo mutuo y la participación activa de todos los integrantes del equipo. <br>AV2: Participé en la revisión de avances de la Landing Page y del backend, promoviendo la colaboración entre los integrantes y apoyando la resolución conjunta de observaciones y mejoras identificadas. <br>**TB2:** Colaboré en la revisión de las funcionalidades desarrolladas, apoyando la integración entre el frontend y el backend, la resolución de incidencias detectadas y la validación del despliegue final de la aplicación. | **Conclusión grupal:** Durante la TB2, el equipo fortaleció el liderazgo compartido mediante la coordinación de las actividades de corrección de errores, integración y despliegue de la aplicación. La comunicación constante, el apoyo mutuo y la participación activa de todos los integrantes permitieron completar el desarrollo del backend, integrarlo exitosamente con el frontend y resolver las incidencias detectadas, logrando una versión estable y completamente funcional del sistema.| **Conclusión grupal:** Durante el desarrollo de la TB1, el equipo logró trabajar de manera colaborativa y organizada, promoviendo un liderazgo conjunto en cada una de las actividades realizadas. Todos los integrantes participaron activamente en el desarrollo del frontend correspondiente a los Sprint 1 y Sprint 2, así como en la corrección de observaciones del reporte. La comunicación constante y el apoyo mutuo permitieron cumplir los objetivos planteados y fortalecer el trabajo en equipo.<br><br> **AV1:** Durante la AV1, el equipo mantuvo una dinámica de trabajo colaborativa en la elaboración del reporte del proyecto y el desarrollo de la Landing Page. La coordinación entre los integrantes, el intercambio de ideas y la distribución de responsabilidades permitieron avanzar de manera organizada y cumplir satisfactoriamente los objetivos de esta etapa.<br><br> **AV2:** Durante la AV2, el equipo trabajó de forma coordinada en el desarrollo de los primeros módulos del backend correspondientes al Sprint 3. La colaboración constante y el liderazgo compartido facilitaron la implementación de funcionalidades, la integración de aportes y el cumplimiento eficiente de las actividades planificadas.<br><br> **TB2:** Durante la TB2, el equipo fortaleció el liderazgo compartido mediante la coordinación de las actividades finales del proyecto. La comunicación constante y el apoyo entre los integrantes permitieron corregir los errores del frontend y backend, completar el desarrollo del backend, integrarlo con el frontend y realizar el despliegue exitoso de la aplicación, obteniendo una solución completamente funcional.|
| 5.c.2 Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | Sebastian Martin Beingolea Montalvo — U202217853<br>TB1: Promoví un entorno colaborativo dentro del equipo al coordinar la definición de metas y la distribución de tareas, asegurando que todos los integrantes pudieran cumplir sus responsabilidades en los tiempos establecidos.<br>TP: Participé en la planificación de las actividades relacionadas con las mejoras del documento y el Sprint 2, cumpliendo con las tareas asignadas dentro de los plazos establecidos para asegurar el avance del proyecto.<br>AV2: Participé en la planificación de las mejoras del documento y en la definición de objetivos para la Landing Page, cumpliendo con las actividades asignadas dentro de los plazos establecidos.<br>**TB2:** Participé en la planificación de las actividades finales del proyecto, priorizando la corrección de errores, la integración del frontend con el backend y el despliegue de la aplicación dentro de los plazos establecidos.<br><br>Villanueva Rodríguez Giuseppe Adrián — U20221c554<br>TB1: Contribuí a mantener un ambiente inclusivo y organizado, apoyando en la planificación de actividades grupales y cumpliendo oportunamente con los objetivos asignados para el desarrollo del proyecto.<br>TP: Organicé mis actividades de revisión y actualización del documento de acuerdo con los objetivos del equipo, contribuyendo al cumplimiento oportuno de las entregas establecidas para la TP.<br>AV2: Organicé mis tareas de revisión y actualización documental de acuerdo con el cronograma del equipo, contribuyendo al cumplimiento de los entregables previstos para esta etapa del proyecto.<br>**TB2:** Organicé mis actividades de revisión y validación de funcionalidades de acuerdo con las metas del equipo, contribuyendo al cumplimiento de los objetivos finales del proyecto.<br><br>Saul Ortega Muñoz — U20231c019<br>TB1: Participé activamente en la planificación y seguimiento de tareas, fomentando la cooperación entre los integrantes para garantizar el cumplimiento de las metas establecidas en la TB1.<br>TP: Colaboré en la planificación y desarrollo de las funcionalidades del frontend, organizando mis tareas de acuerdo con los objetivos establecidos y cumpliendo oportunamente con la entrega de componentes para contribuir al avance del proyecto.<br>AV2: Planifiqué y desarrollé las tareas asignadas para la Landing Page y la implementación parcial del backend, cumpliendo los objetivos definidos y entregando los componentes correspondientes dentro del tiempo acordado.<br>**TB2:** Planifiqué y desarrollé las tareas asignadas para la corrección de errores y la integración de componentes, cumpliendo oportunamente con los entregables establecidos para esta etapa del proyecto.<br><br>Alejandro Manuel Jave Chang — U202312510<br>TB1: Colaboré en la organización de las actividades del equipo y en la estimación de tiempos de trabajo, contribuyendo a un entorno de respeto y apoyo mutuo orientado al logro de objetivos comunes. <br>TP: Participé en la organización y desarrollo del capítulo 5 del proyecto, planificando mis tareas de manera responsable para cumplir con los objetivos y entregables definidos para el Sprint 2.<br>AV2: Participé en la organización y seguimiento de las actividades del proyecto, gestionando adecuadamente mis responsabilidades para contribuir al cumplimiento de las metas establecidas para la entrega.<br>**TB2:** Participé en la organización y seguimiento de las actividades relacionadas con la finalización del backend y la validación de la integración, gestionando mis responsabilidades para contribuir al cumplimiento de las metas del Sprint.<br><br>Valentin Nicolas Medina Mamani — U202316829<br>TB1: Apoyé en la coordinación de las tareas semanales y en la comunicación constante del equipo, promoviendo un ambiente participativo que permitió cumplir con los objetivos del reporte de manera eficiente.  <br>TP: Apoyé en la coordinación de las mejoras del documento y en la revisión de avances del Sprint 2, colaborando con el equipo para cumplir las metas propuestas de manera eficiente y organizada. <br>AV2: Apoyé en la coordinación de las mejoras documentales y en la revisión de avances del desarrollo, colaborando con el equipo para alcanzar los objetivos planteados de manera eficiente y organizada.<br>**TB2:** Apoyé en la coordinación de las actividades de validación y despliegue del sistema, colaborando con el equipo para cumplir los objetivos planteados y asegurar la entrega de una aplicación completamente funcional. | **Conclusión grupal:** Durante la TB2, el equipo mantuvo un entorno colaborativo e inclusivo mediante una adecuada planificación de las actividades pendientes y una distribución equilibrada de responsabilidades. Se establecieron como objetivos la corrección de errores del frontend y backend, la finalización del backend, la integración completa entre ambos componentes y el despliegue exitoso de la aplicación. Gracias al compromiso y coordinación de todos los integrantes, se cumplieron satisfactoriamente las metas planteadas, obteniendo una solución completamente integrada y operativa.                                                                                                                                                                                                                                                                                                                               | **Conclusión grupal:** Durante el desarrollo de la TB1, el equipo logró crear un entorno colaborativo e inclusivo mediante una adecuada planificación de las actividades relacionadas con el desarrollo del frontend y la corrección del reporte. La distribución equilibrada de responsabilidades y el seguimiento constante de los avances permitieron cumplir los objetivos establecidos para los Sprint 1 y Sprint 2.<br><br> **AV1:** En la AV1, el equipo mantuvo un entorno colaborativo e inclusivo gracias a la organización de las tareas relacionadas con la elaboración del reporte y el desarrollo de la Landing Page. La planificación constante y la participación activa de todos los integrantes permitieron cumplir oportunamente con los entregables previstos para esta etapa.<br><br> **AV2:** En la AV2, el equipo planificó y desarrolló de manera organizada las actividades correspondientes al Sprint 3, implementando parte del backend y realizando un seguimiento continuo de los avances. La distribución de responsabilidades y la colaboración permanente permitieron alcanzar los objetivos establecidos para esta entrega.<br><br> **TB2:** En la TB2, el equipo mantuvo un entorno colaborativo e inclusivo mediante una adecuada planificación de las actividades finales del proyecto y una distribución equilibrada de responsabilidades. Se establecieron como metas la corrección de errores del frontend y backend, la finalización del backend, la integración completa con el frontend y el despliegue de la aplicación. Gracias al compromiso de todos los integrantes, se cumplieron satisfactoriamente los objetivos del Sprint 4, obteniendo una aplicación completamente integrada y operativa.                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| **Sprint Goal & User Stories** | |
| **Sprint 4 Goal** | Nuestro objetivo es resolver los errores existentes y perfeccionar la interfaz de usuario de la aplicación BuildingFex, que ya está plenamente operativa. Creemos que ofrece una experiencia muy estable, sin errores y muy pulida tanto a los administradores de fincas como a los residentes. Esto quedará confirmado cuando se hayan resuelto todos los errores de gravedad alta y media registrados en la lista de tareas pendientes, los formularios de la interfaz de usuario gestionen correctamente la validación y la aplicación supere las pruebas finales de control de calidad sin interrupciones críticas.|
...
* La respuesta exitosa de los servicios hacia la interfaz de usuario y herramientas de prueba (ej. Postman/Swagger).
![teamcollab1](../imagenes/31.png)
![teamcollab2](../imagenes/32.png)
![teamcollab3](../imagenes/33.png)
![teamcollab4](../imagenes/34.png)
![teamcollab5](../imagenes/35.png)
![teamcollab6](../imagenes/36.png)
...
![teamcollab2](../imagenes/13.png)
![teamcollab3](../imagenes/14.png)
![teamcollab4](../imagenes/15.png)
![teamcollab5](../imagenes/16.png)
![teamcollab6](../imagenes/17.png)
![teamcollab6](../imagenes/18.png)
![teamcollab6](../imagenes/19.png)
![teamcollab6](../imagenes/20.png)
![teamcollab6](../imagenes/21.png)
![teamcollab6](../imagenes/22.png)
![teamcollab6](../imagenes/23.png)
