...
| **Sprint Goal & User Stories** | |
| **Sprint 4 Goal** | Nuestro objetivo es resolver los errores existentes y perfeccionar la interfaz de usuario de la aplicación BuildingFex, que ya está plenamente operativa.
Creemos que ofrece una experiencia muy estable, sin errores y muy pulida tanto a los administradores de fincas como a los residentes.
Esto quedará confirmado cuando se hayan resuelto todos los errores de gravedad alta y media registrados en la lista de tareas pendientes, los formularios de la interfaz de usuario gestionen correctamente la validación y la aplicación supere las pruebas finales de control de calidad sin interrupciones críticas.|
